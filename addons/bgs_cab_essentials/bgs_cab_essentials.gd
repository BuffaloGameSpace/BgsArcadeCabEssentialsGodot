...
#region Player Input
const default_action_set:PlayerInputActionSet = preload("res://addons/bgs_cab_essentials/resources/player_input/action_sets/default_action_set.tres")
#endregion

#region Bottom Panel
const main_ui := preload("res://addons/bgs_cab_essentials/ui/main_ui.tscn")
...
func _setup_credits_autoload() -> void:
	add_autoload_singleton(BgsCabConsts.AutoloadNames.credits, "res://addons/bgs_cab_essentials/autoloads/bgs_credits_autoload.gd")	
...
func _setup_idle_quit_autoload() -> void:
	add_autoload_singleton(BgsCabConsts.AutoloadNames.idle_quit, "res://addons/bgs_cab_essentials/autoloads/bgs_idle_quit_autoload.gd")
...
func _setup_general_autoload() -> void:
	add_autoload_singleton(BgsCabConsts.AutoloadNames.general_config, "res://addons/bgs_cab_essentials/autoloads/bgs_general_autoload.gd")
